        ...
        return io.Schema(
            ...
            inputs=[
                ...
                io.Combo.Input(
                    ...
                    tooltip=(
                        'standard keeps the upstream full-query native Kitchen '
                        'path. streamed is an explicit low-VRAM ConvRot INT8 '
                        'path: K/V stay as INT8 carriers while Q, attention '
                        'output, and FinalLayer work are bounded in chunks. '
                        'Streamed is intentionally opt-in and currently requires '
                        'native Kitchen sparse attention.'
                    ),
                ),
                io.Int.Input(
                    'query_chunk_rows',
                    ...
                    advanced=True,
                    tooltip=(
                        'Maximum query rows processed by streamed native Kitchen '
                        'attention at once. Lower values reduce transient VRAM; '
                        'larger values reduce launch/projection overhead.'
                    ),
                ),
                io.Int.Input(
                    'chunk_rows',
