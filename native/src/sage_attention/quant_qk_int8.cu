...
//   No __syncthreads anywhere â€“ pure warp-level reductions.
//
...
// ---------------------------------------------------------------------------
// Fused Q+K kernel â€“ fallback for non-standard tile configs.
// blockIdx.x < q_oblk_count  â†’  Q path
// blockIdx.x >= q_oblk_count â†’  K path
// ---------------------------------------------------------------------------
